...
class NumberOfAuthorsBonusSpec extends Specification {
  ...
  "rater" should {
    ...
    "rate non-pictured first year" in {
      ...
      rater.explain("01-123-0001", "author 1") === "Pictured before by 0 (0-0) authors = 9.0"
    }
    ...
    "rate pictured twice by same author with sameAuthorZeroBonus" in {
      ...
      rater.explain("01-123-0001", "author 1") === "Pictured by same author before = 0.0"
    }
    ...
    "rate pictured twice by same author without sameAuthorZeroBonus" in {
      ...
      rater.explain("01-123-0001", "author 1") === "Pictured before by 1 (1-3) authors = 3.0"
    }
  }
}
