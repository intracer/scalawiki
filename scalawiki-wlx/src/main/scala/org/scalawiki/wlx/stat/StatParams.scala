...
class StatParams(arguments: Seq[String]) extends ScallopConf(arguments) {
  ...
  val newObjectRating = opt[Double](name = "new-object-rating", descr = "new object rating")
  val newAuthorObjectRating = opt[Double](name = "new-author-object-rating", descr = "new author object rating")
