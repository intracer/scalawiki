...
/** Maps constant English field names to possibly localized field names in
  * monument lists
  */
trait ListConfig {
...
case class ListConfigImpl(templateName: String, namesMap: Map[String, String])
    extends ListConfig
...
class OtherTemplateListConfig(val templateName: String, base: ListConfig)
    extends ListConfig {
