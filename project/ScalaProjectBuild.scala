...
//          "org.codehaus.woodstox" % "stax2-api" % "3.1.4",
          ...
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.mwdumper" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.util" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.api" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.datamachine" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.timemachine" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.revisionmachine" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.wikimachine" % "1.0.0" withSources() withJavadoc(),
//          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia" % "1.0.0" withSources() withJavadoc(),
          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.parser" % "1.0.0" withSources() withJavadoc(),
//          "de.tudarmstadt.ukp.wikipedia" % "de.tudarmstadt.ukp.wikipedia.dist" % "1.0.0" withSources() withJavadoc(),
