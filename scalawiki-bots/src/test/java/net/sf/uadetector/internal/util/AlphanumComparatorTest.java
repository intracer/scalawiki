...
public class AlphanumComparatorTest {
    ...
    public void compare_0_0() {
        ...
        assertThat(new AlphanumComparator().compare(charA, charB), is(0));
    }
    ...
    public void compare_0_0000() {
        ...
        assertThat(new AlphanumComparator().compare(charA, charB), is(-3));
        assertThat(new AlphanumComparator().compare(charB, charA), is(3));
    }
    ...
    public void compare_02_2() {
        ...
        assertThat(new AlphanumComparator().compare(charA, charB), is(1));
        assertThat(new AlphanumComparator().compare(charB, charA), is(-1));
    }
    ...
    public void compare_02_20() {
        ...
        assertThat(new AlphanumComparator().compare(charA, charB), is(-2));
        assertThat(new AlphanumComparator().compare(charB, charA), is(2));
    }
    ...
    public void compare_differentFlags() {
        ...
        assertThat(new AlphanumComparator().compare(version1, version2), is(-1));
        assertThat(new AlphanumComparator().compare(version2, version1), is(1));
    }
    ...
    public void compare_identical() {
        ...
        assertThat(new AlphanumComparator().compare(version1, version2), is(0));
    }

    @Test
    public void compare_list() {
        final List<String> src = new ArrayList<>(18);
        src.add("0");
        src.add("1");
        src.add("00");
        src.add("01");
    ...
    public void compare_same() {
        ...
        assertThat(new AlphanumComparator().compare(version, version), is(0));
    }
    ...
    public void compareDigits_001_xyz() {
        ...
        assertThat(AlphanumComparator.compareDigits(charA, charB), is(-72));
        assertThat(AlphanumComparator.compareDigits(charB, charA), is(72));
    }
    ...
    public void compareDigits_1_00() {
        ...
        assertThat(AlphanumComparator.compareDigits(charA, charB), is(-1));
        assertThat(AlphanumComparator.compareDigits(charB, charA), is(1));
    }
    ...
    public void compareDigits_abc_xyz() {
        ...
        final String charB = "xyz";
        assertThat(AlphanumComparator.compareDigits(charA, charB), is(-23));
        assertThat(AlphanumComparator.compareDigits(charB, charA), is(23));
    }
