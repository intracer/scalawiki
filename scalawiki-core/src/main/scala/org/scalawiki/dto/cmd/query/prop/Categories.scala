...
case class Categories(override val params: CategoriesParam[Any]*)
  extends Module[PropArg]("cl", "categories", "Gets a list of all categories used on the provided pages.")
  with PropArg with ArgWithParams[CategoriesParam[Any], PropArg]
...
case class ClLimit(override val arg: String) extends StringParameter("cllimit",
  "How many categories to return") with CategoriesParam[String]