...
case class CmProp(override val args: CmPropArg*)
  extends EnumParameter[CmPropArg]("cmprop", "Which properties to get for each revision:") with CmParam[CmPropArg]

package cmprop {

  object Ids extends EnumArgument[CmPropArg]("ids", "Adds the page ID.") with CmPropArg

  object Title extends EnumArgument[CmPropArg]("title", "Adds the title and namespace ID of the page.") with CmPropArg

  object SortKey extends EnumArgument[CmPropArg]("sortkey", "Adds the sortkey used for sorting in the category (hexadecimal string).") with CmPropArg

  object SortKeyPrefix extends EnumArgument[CmPropArg]("sortkeyprefix", "Adds the sortkey prefix used for sorting in the category (human-readable part of the sortkey).") with CmPropArg

  object Timestamp extends EnumArgument[CmPropArg]("timestamp", "Adds the timestamp of when the page was included.") with CmPropArg
...
case class CmSort(override val args: CmSortArg*)
  extends EnumParameter[CmSortArg]("cmsort", "Property to sort by.") with CmParam[CmSortArg]
...
case class CmDir(override val args: CmDirArg*)
  extends EnumParameter[CmDirArg]("cmdir", "In which direction to sort.") with CmParam[CmDirArg]
