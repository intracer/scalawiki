  ...
  "thumbUrl" should {
    ...
    "resize url" in {
      ...
      Gallery.thumbUrl(
        ...
        600,
        true
      ) === "https://host/image.jpg/800px-image.jpg"
    }
    ...
    "resize long url" in {
      ...
      Gallery.thumbUrl(
        ...
        600,
        true
      ) === s"https://host/$title/800px-thumbnail.jpg"
    }
    ...
    "resize sublong url" in {
      ...
      Gallery.thumbUrl(
        ...
        600,
        true
      ) === s"https://host/$title/800px-$title"
    }
    ...
    "resize pdf url" in {
      ...
      Gallery.thumbUrl(
        ...
        600,
        true
      ) === s"https://host/$title/page1-800px-$title.jpg"
    }
    ...
    "resize tiff url" in {
      ...
      Gallery.thumbUrl(
        ...
        600,
        true
      ) === s"https://host/$title/lossy-page1-800px-$title.jpg"
    }
