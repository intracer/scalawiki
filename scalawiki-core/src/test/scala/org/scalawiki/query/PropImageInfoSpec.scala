...
class PropImageInfoSpec extends Specification with MockBotSpec {
  ...
  val page1 = Page(Some(32885574), Some(6), "File:Dovbush-rocks 01.JPG", Seq.empty,
  ...
  val page2 = Page(Some(32885597), Some(6), "File:Dovbush-rocks 02.JPG", Seq.empty,
  ...
  "get image info in generator" should {
    ...
    "get metadata" in {
      ...
      metadata.date === Some(ZonedDateTime.of(2017, 4, 22, 12, 26, 44, 0, ZoneOffset.UTC))
    }
  }
}
